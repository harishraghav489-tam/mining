...
export function AiInsightPanel() {
  ...
  const localizedSummary = isCritical
    ? t('aiInsight.criticalSummary')
    : isWarning
    ? t('aiInsight.warningSummary')
    : t('aiInsight.safeSummary');

  const localizedActions = isCritical
    ? [t('aiInsight.criticalAction1'), t('aiInsight.criticalAction2')]
    : isWarning
    ? [t('aiInsight.warningAction1'), t('aiInsight.warningAction2')]
    : [t('aiInsight.safeAction1'), t('aiInsight.safeAction2')];
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-400">
                {t('aiInsight.generatedAt', { time: insight.generatedAt })}
              </p>
            </div>
          </div>
          <span className="text-[10px] font-bold px-2 py-0.5 rounded-full bg-slate-100 text-slate-700">
            {t('aiInsight.llmLayer')}
          </span>
        </div>

...
locales = {
    ...
    "ta": {
        ...
        "dashboard": {
            ...
            "title": "Subsisense AI முகப்பு பலகை",
...
languages_meta = {
    "te": {
        ...
        "dashboard": {"dashboard": "డాష్‌బోర్డ్", "overview": "అవలోకనం", "monitoring": "లైవ్ పర్యవేక్షణ", "riskLevel": "భౌగోళిక సాంకేతిక ప్రమాద స్థాయి", "activeSensors": "క్రియాశీల సెన్సార్లు", "lastUpdated": "చివరిగా నవీకరించబడింది", "title": "Subsisense AI డాష్‌బోర్డ్", "systemStatus": "సిస్టమ్ స్థితి"},
        ...
        "brand": {"name": "Subsisense AI", "tagline": "సురక్షితమైన గనులు. మంచి రేపు.", "slogan": "పర్యవేక్షణ • అంచనా • నివారణ", "hackathon": "Smart India Hackathon 2026 నమూనా"},
    ...
    "kn": {
        ...
        "dashboard": {"dashboard": "ಡ್ಯಾಶ್‌ಬೋರ್ಡ್", "overview": "ಅವಲೋಕನ", "monitoring": "ನೇರ ಮೇಲ್ವಿಚಾರಣೆ", "riskLevel": "ಭೂತಾಂತ್ರಿಕ ಅಪಾಯದ ಮಟ್ಟ", "activeSensors": "ಸಕ್ರಿಯ ಸಂವೇದಕಗಳು", "lastUpdated": "ಕೊನೆಯದಾಗಿ ನವೀಕರಿಸಲಾಗಿದೆ", "title": "Subsisense AI ಡ್ಯಾಶ್‌ಬೋರ್ಡ್", "systemStatus": "ವ್ಯವಸ್ಥೆಯ ಸ್ಥಿತಿ"},
        ...
        "brand": {"name": "Subsisense AI", "tagline": "ಸುರಕ್ಷಿತ ಗಣಿಗಳು. ಉತ್ತಮ ಭವಿಷ್ಯ.", "slogan": "ಮೇಲ್ವಿಚಾರಣೆ • ಮುನ್ಸೂಚನೆ • ತಡೆಗಟ್ಟುವಿಕೆ", "hackathon": "Smart India Hackathon 2026 ಮಾದರಿ"},
    ...
    "ml": {
        ...
        "dashboard": {"dashboard": "ഡാഷ്‌ബോർഡ്", "overview": "അവലോകനം", "monitoring": "തത്സമയ നിരീക്ഷണം", "riskLevel": "ഭൂസാങ്കേതിക അപകട സാധ്യത", "activeSensors": "സജീവ സെൻസറുകൾ", "lastUpdated": "അവസാനം പുതുക്കിയത്", "title": "Subsisense AI ഡാഷ്‌ബോർഡ്", "systemStatus": "സിസ്റ്റം നില"},
        ...
        "brand": {"name": "Subsisense AI", "tagline": "സുരക്ഷിത ഖനികൾ. മികച്ച നാളെ.", "slogan": "നിരീക്ഷിക്കുക • പ്രവചിക്കുക • തടയുക", "hackathon": "Smart India Hackathon 2026 മാതൃക"},
    ...
    "bn": {
        ...
        "dashboard": {"dashboard": "ড্যাশবোর্ড", "overview": "সংক্ষিপ্ত বিবরণ", "monitoring": "লাইভ নজরদারি", "riskLevel": "ভূ-প্রযুক্তিগত ঝুঁকির স্তর", "activeSensors": "সক্রিয় সেন্সর", "lastUpdated": "সর্বশেষ আপডেট", "title": "Subsisense AI ড্যাশবোর্ড", "systemStatus": "সিস্টেমের অবস্থা"},
        ...
        "brand": {"name": "Subsisense AI", "tagline": "নিরাপদ খনি। উজ্জ্বল ভবিষ্যৎ।", "slogan": "নজরদারি • পূর্বাভাস • প্রতিরোধ", "hackathon": "Smart India Hackathon 2026 প্রোটোটাইপ"},
    ...
    "mr": {
        ...
        "dashboard": {"dashboard": "डॅशबोर्ड", "overview": "आढावा", "monitoring": "थेट देखरेख", "riskLevel": "भू-तांत्रिक जोखीम पातळी", "activeSensors": "सक्रिय सेन्सर्स", "lastUpdated": "शेवटचे अद्यतन", "title": "Subsisense AI डॅशबोर्ड", "systemStatus": "सिस्टम स्थिती"},
        ...
        "brand": {"name": "Subsisense AI", "tagline": "सुरक्षित खाणी. उज्ज्वल भविष्य.", "slogan": "निरीक्षण • अंदाज • प्रतिबंध", "hackathon": "Smart India Hackathon 2026 प्रोटोटाइप"},
    ...
    "gu": {
        ...
        "dashboard": {"dashboard": "ડેશબોર્ડ", "overview": "ઝાંખી", "monitoring": "લાઇવ મોનિટરિંગ", "riskLevel": "ભૂ-તકનીકી જોખમ સ્તર", "activeSensors": "સક્રિય સેન્સર્સ", "lastUpdated": "છેલ્લું અપડેટ", "title": "Subsisense AI ડેશબોર્ડ", "systemStatus": "સિસ્ટમ સ્થિતિ"},
        ...
        "brand": {"name": "Subsisense AI", "tagline": "સલામત ખાણો. ઉજ્જવળ ભવિષ્ય.", "slogan": "મોનિટર • આગાહી • નિવારણ", "hackathon": "Smart India Hackathon 2026 પ્રોટોટાઇપ"},
    ...
    "pa": {
        ...
        "dashboard": {"dashboard": "ਡੈਸ਼ਬੋਰਡ", "overview": "ਸੰਖੇਪ ਜਾਣਕਾਰੀ", "monitoring": "ਲਾਈਵ ਨਿਗਰਾਨੀ", "riskLevel": "ਭੂ-ਤਕਨੀਕੀ ਜੋਖਮ ਪੱਧਰ", "activeSensors": "ਸਰਗਰਮ ਸੈਂਸਰ", "lastUpdated": "ਆਖਰੀ ਅੱਪਡੇਟ", "title": "Subsisense AI ਡੈਸ਼ਬੋਰਡ", "systemStatus": "ਸਿਸਟਮ ਸਥਿਤੀ"},
        ...
        "brand": {"name": "Subsisense AI", "tagline": "ਸੁਰੱਖਿਅਤ ਖਾਣਾਂ। ਬਿਹਤਰ ਭਵਿੱਖ।", "slogan": "ਨਿਗਰਾਨੀ • ਭਵਿੱਖਬਾਣੀ • ਰੋਕਥਾਮ", "hackathon": "Smart India Hackathon 2026 ਪ੍ਰੋਟੋਟਾਈਪ"},
    ...
    "or": {
        ...
        "dashboard": {"dashboard": "ଡ୍ୟାସବୋର୍ଡ", "overview": "ସମୀକ୍ଷା", "monitoring": "ପ୍ରତ୍ୟକ୍ଷ ନିରୀକ୍ଷଣ", "riskLevel": "ଭୂ-ବୈଷୟିକ ବିପଦ ସ୍ତର", "activeSensors": "ସକ୍ରିୟ ସେନ୍ସର", "lastUpdated": "ଶେଷ ଅଦ୍ୟତନ", "title": "Subsisense AI ଡ୍ୟାସବୋର୍ଡ", "systemStatus": "ସିଷ୍ଟମ ସ୍ଥିତି"},
        ...
        "brand": {"name": "Subsisense AI", "tagline": "ନିରାପଦ ଖଣି। ଉନ୍ନତ ଭବିଷ୍ୟତ।", "slogan": "ନିରୀକ୍ଷଣ • ପୂର୍ବାନୁମାନ • ପ୍ରତିରୋଧ", "hackathon": "Smart India Hackathon 2026 ପ୍ରୋଟୋଟାଇପ୍"},
    ...
    "as": {
        ...
        "dashboard": {"dashboard": "ডেচবৰ্ড", "overview": "অৱলোকন", "monitoring": "প্ৰত্যক্ষ নিৰীক্ষণ", "riskLevel": "ভূ-কাৰিকৰী বিপদৰ মাত্ৰা", "activeSensors": "সক্ৰিয় চেন্সৰসমূহ", "lastUpdated": "শেহতীয়া আপডেট", "title": "Subsisense AI ডেচবৰ্ড", "systemStatus": "ছিষ্টেম স্থিতি"},
        ...
        "brand": {"name": "Subsisense AI", "tagline": "সুৰক্ষিত খনি। উজ্জ্বল ভৱিষ্যত।", "slogan": "নিৰীক্ষণ • পূৰ্বানুমান • প্ৰতিৰোধ", "hackathon": "Smart India Hackathon 2026 প্ৰ'ট'টাইপ"},
